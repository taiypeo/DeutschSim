...
public class LexicalAnalyzer {
    ...
    private void skip_whitespace() {
        while (current_position < expression.length() && Character.isWhitespace(expression.charAt(current_position)))
            current_position++;
    }
    ...
    private Token integer_token() {
        ...
        for (; current_position < expression.length()
                && Character.isDigit(expression.charAt(current_position)); current_position++)
