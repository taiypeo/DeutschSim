...
public class GateTable extends JPanel {
    ...
    public GateTable(final int gate_table_cell_size, final int gate_table_row_height, final JFrame frame) {
            ...
            for (int col = 0; col < table.get_col_count(); col++) {
                ...
                if (gate != null) {
                    ...
                    if (gate.get_id().equals(Tools.CONTROL_ID))
                        ...
                        final int text_width = (int) Tools.gate_font.getStringBounds(gate.get_id(), frc).getWidth();
            ...
            if (SwingUtilities.isRightMouseButton(ev)) {
                ...
                for (int first_row = row; first_row >= 0; first_row--) {
                    ...
                    if (current != null && row - first_row + 1 <= current.get_ports_number()) {
                        ...
                        if (table.get_table().get_col_count() > 1 && col == table.get_table().get_col_count() - 2
