...
public class StandardGateCreator {
    public static Gate create_pauli_x() {
        Complex[][] data = new Complex[][] { { new Complex(0), new Complex(1) }, { new Complex(1), new Complex(0) } };

        return new Gate("X", new Array2DRowFieldMatrix<Complex>(data));
    }

    public static Gate create_pauli_y() {
        Complex[][] data = new Complex[][] { { new Complex(0), new Complex(0, -1) },
    ...
    public static Gate create_pauli_z() {
        Complex[][] data = new Complex[][] { { new Complex(1), new Complex(0) }, { new Complex(0), new Complex(-1) } };

        return new Gate("Z", new Array2DRowFieldMatrix<Complex>(data));
    }

    public static Gate create_hadamard() {
        Complex[][] data = new Complex[][] { { new Complex(1), new Complex(1) }, { new Complex(1), new Complex(-1) } };
