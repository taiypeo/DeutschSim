...
public class Interpreter {
    ...
    private Complex function() {
        ...
        switch (func) {
        case SQRT:
            if (Tools.equal(value.getImaginary(), 0.0) && FastMath.copySign(1.0, value.getImaginary()) < 0.0) // check
                                                                                                              // for
                                                                                                              // negative
                                                                                                              // zero in
                                                                                                              // the
    ...
    private Complex convert_to_radians(final Complex angle) {
        if (angle_type == Tools.AngleType.DEGREES)
            return new Complex(Math.toRadians(angle.getReal()), Math.toRadians(angle.getImaginary()));
